...
![Document Intelligence Agent — System Architecture](../diagrams/system-architecture.svg)
...
![Context Assembly: Three Layers](../diagrams/context-pipeline-layers.svg)
...
![Observe-Think-Act Loop](../diagrams/observe-think-act.svg)
